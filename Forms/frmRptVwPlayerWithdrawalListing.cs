...
{
	/// <summary>
	/// Summary description for frmRptVwPlayerWithdrawaltListing.
	/// </summary>
	public class frmRptVwPlayerWithdrawaltListing : frmReportBase
	{
		/// <summary>
		...
		#region Construtor
		public frmRptVwPlayerWithdrawaltListing()
		{
			//
			...
			base.ReportID = "PCS_RPTPlayerWithdrawalListing";
		...
		protected override void HandleReport()
		{
			...
			oRpt.View_PlayerWithdrawalListing(base.ReportID, base.oParamFields, base.oReportHeaderParamFields, 
